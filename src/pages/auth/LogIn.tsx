        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              >
                {t("content.auth.login.email_label")}
              </label>
              <Input
                id="email"
                name="email"
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-foreground mb-1"
              >
                {t("content.auth.login.password_label")}
              </label>
              <Input
                id="password"
                name="password"
          ...
          >
            {t("content.auth.login.submit")}
          </button>

          <div className="text-center text-sm">
            <span className="text-muted-foreground">
              {t("content.auth.login.no_account")}{" "}
            </span>
            <Link
              to="/auth/signup"
              className="font-medium text-primary hover:text-primary/80"
            >
              {t("content.auth.login.sign_up_link")}
            </Link>
          </div>
        </form>
      </div>
